...
<header class="bg-dark" id="main-header position-relative">
        <div class="text-center text-white">
            ...
            <div class="position-absolute top-50 start-50 translate-middle">
                 <h1 class="display-1 text-secondary fw-bolder">About</h1>
  ...
  <div class="row g-4 pb-5">
    ...
    <div class="col-12 col-md-4" data-aos="fade-up">
      <div class="card border-0 shadow h-100 p-4 text-center">
        ...
        <p class="text-muted">Top-quality supplies and care, ensuring happy tails and paws. Your pets deserve the best.</p>
      </div>
    </div>
  </div>
</div>
