...
<div class="container-fluid text-center my-5 bg-light p-5">
...
<section class="about-us-section py-5 bg-custom">
        ...
        <div class="row g-6 mb-lg-15 mb-md-10 mb-8 justify-content-center  align-items-center py-5">
            ...
            <!-- <div class="col-lg-4 col-md-6 col-xs-10">
                <div class="service-card text-center egg-shape bg-secondary2">
                    ...
                    <a href="service-details.html" class="text-animation-line text-h3 text-n20 font-otomanopee fw-normal mb-4 hover-underline">Pet Grooming</a>
                    <p class="text-n20">
                        Keep your pets looking their best with our full-service grooming. From baths to nail trims, our expert groomers.
                    </p>
                </div>
            </div> -->
            <!-- Card4 -->
